...
config db;
    ...
    private void initComponents() {
        ...
        jLabel2.setToolTipText("Primary");
        ...
        jLabel4.setToolTipText("Secondary");
        ...
        tcx.setColumns(20);
        tcx.setRows(5);
        jScrollPane1.setViewportView(tcx);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(cn2, javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(nm, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(26, 26, 26)
...
chooser.showOpenDialog(null);
        ...
        String filesign = ff.getAbsolutePath();
        System.out.println(filesign);
        // TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
String na=nm.getText();
String nb=cn1.getText();
String nc=cn2.getText();
String nd=tcx.getText();
String filename = f.getAbsolutePath();
String filesign = ff.getAbsolutePath();
//String s2="create table "+na+" (Serial No. integer , Product ID integer, Product Name varchar(255), Quantity integer, Price float)";
/*String sql="CREATE TABLE "+na+
                   " (Serial No. INTEGER not NULL, " +
                   " Product ID INTEGER, " + 
                   " Product Name VARCHAR(255), " + 
                   " Quantity INTEGER, " + 
                   " PRIMARY KEY ( id )"+" Price FLOAT)";*/
//String sql="CREATE TABLE `"+na+"`( `Serial_No.` INT(255) NOT NULL AUTO_INCREMENT, `Product_Name` VARCHAR(255), `Product_ID` INTEGER, `Quantity` INTEGER, `Price` FLOAT, PRIMARY KEY (`Serial_No.`) );";
//String sql="CREATE TABLE `"+na+"`( `Serial_No.` INT(255) NOT NULL AUTO_INCREMENT, `Product_Name` VARCHAR(255), `Product_ID` INTEGER, `Quantity` INTEGER, `Price` FLOAT, PRIMARY KEY (`Serial_No.`) );";
//System.out.println(sql);
String s1="insert into customer values(null,'"+na+"','"+nb+"','"+nc+"','"+nd+"','"+filename+"','"+filesign+"')";
System.out.println(s1);
setVisible(false);
try{db.mix(s1,"Thank You for selling your SOUL to us. . .");/*db.fix(sql,"Enjoy");*/}
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                A2 w=new A2();
                w.setVisible(true);
                w.setTitle("Customer Registration");
            }
        });
    }
    ...
    private javax.swing.JTextArea tcx;
